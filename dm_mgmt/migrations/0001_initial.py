    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('service_duration', models.PositiveSmallIntegerField(blank=True, null=True, verbose_name='Durée du massage (en minutes)')),
                ('service_comment', models.TextField(blank=True, null=True, verbose_name='Remarque')),
                ('service_cashed_price', models.FloatField(verbose_name='Montant encaissé (CHF)')),
        ...
        migrations.RunSQL(
            """
            CREATE OR REPLACE VIEW dm_mgmt_conso_service
             AS
