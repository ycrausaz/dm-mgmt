...
class ServiceForm(ModelForm):
    class Meta:
        ...
        widgets = {
            'service_client_id': forms.Select(attrs={'class':'form-control selectpicker', 'style':'width: 300px;', 'data-live-search':'true', 'data-live-search-style':'contains', 'data-max-options':'1'}),#, 'placeholder':'Nom du client'}),
